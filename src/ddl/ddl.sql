...
insert into vue_Images(image_name,image_path,image_title,image_content,image_category_id,image_create_time,image_view_time) values('1.jpg','http://192.168.1.3:3000/images/1.jpg','vue轮播图-1.jpg','vue轮播图-1.jpg',2,current_timestamp,5);
insert into vue_Images(image_name,image_path,image_title,image_content,image_category_id,image_create_time,image_view_time) values('beach.jpg','http://192.168.1.3:3000/images/beach.jpg','沙滩','金沙滩之夏，在蓝天下，在阳光里，构成岛城夏季光亮迷人的一道绝景的五彩太阳伞、蒙古包、帐篷及救生泳具沿海岸星罗棋布。游人或租一顶太阳伞遮阳、小憩，谈笑风生；或举家躺卧沙滩上，享受这别具情趣的日光浴；或到近海中游泳，或乘摩托艇穿行在海面上。一把五彩的太阳伞就好像一把浪漫、一手情趣和一种氛围，不知不觉地深植于旅人的心田。也许不曾想过浪漫是什么，浪漫就那么不经意地来到了我们身边。脚踏细沙，眼看大海！晨风照面，舒爽怡人；海味入鼻，直动心灵。白浪横接天地，卷卷而来，翻腾叠起，煞是有威。错落小岛，迫人遐想无穷；游艇飞梭，引动游人心绪。',2,current_timestamp,5);
insert into vue_Images(image_name,image_path,image_title,image_content,image_category_id,image_create_time,image_view_time) values('tuijian.jpg','http://192.168.1.3:3000/images/tuijian.jpg','雪山','云杉坪是一块广阔的草坪，种着杉树，许多牦牛在这里散步。从甘海子去云杉坪之间，有一条深幽的山谷，谷内林木森森，清溪长流，谷底这个清泉长流的河，就是白水河。白水河之水源于四五千米高处的冰川雪原融水，清洌冰凉，遇尔还见到牦牛在这冰冷刺骨的水里洗澡，白水河河床上的石头层层叠叠，像千层酥，又像紫鹊界的梯田。雪山，冰川，耀眼的阳光，没事儿溜达的牦牛，青灰色的岩石，隐隐约约可以听到冰河的咕咕声，雄浑的群山，连绵没有尽头，山顶埋在大雾中，让人望眼欲穿，分不清云层和皑皑白雪，这一切组成了一幅仙境般的画面。',3,current_timestamp,6);
insert into vue_Images(image_name,image_path,image_title,image_content,image_category_id,image_create_time,image_view_time) values('redian.jpg','http://192.168.1.3:3000/images/redian.jpg','《终结者：黑暗命运》','《终结者：黑暗命运》是T-800战斗最激烈壮阔、最为夸张的一次，他不仅是队伍的精神领袖，也是几位女性角色的后盾，戴上墨镜象征着他往昔英勇的回归，他们从高速公路打到空中对撞的“银河C5”运输机，再到水坝的涡轮大厅。一个是公认的“无法战胜的敌人”，一个外表年迈却仍旧是地球最强的战士，这次的故事将是施瓦辛格和汉密尔顿的终极一战。',4,current_timestamp,3);
insert into vue_Images(image_name,image_path,image_title,image_content,image_category_id,image_create_time,image_view_time) values('beijing.jpg','http://192.168.1.3:3000/images/beijing.jpg','北京天安门','隔着长安大街看天安门，白玉石须弥座上，三丈六尺高的抹红泥砖台，上面就是最醒目的城门楼。那庄严肃穆和高大稳固，令人顿生骄傲豪迈之情。',5,current_timestamp,2);
insert into vue_Images(image_name,image_path,image_title,image_content,image_category_id,image_create_time,image_view_time) values('shehui.jpg','http://192.168.1.3:3000/images/shehui.jpg','社会主义价值观','富强、民主、文明、和谐、自由、平等、公正、法治、爱国、敬业、诚信、友善、是社会主义核心价值观的内容。“富强、民主、文明、和谐”是我国社会主义现代化国家的建设目标，"自由、平等、公正、法治"是对美好社会的表述，“爱国、敬业、诚信、友善”是公民基本道德规范。',6,current_timestamp,10);
insert into vue_Images(image_name,image_path,image_title,image_content,image_category_id,image_create_time,image_view_time) values('yule.jpg','http://192.168.1.3:3000/images/yule.jpg','三生三世十里桃花','翼君擎苍向神族挑起战争，神族付出惨痛代价封印了擎苍，同年天孙夜华出世。七万年后擎苍破出封印，青丘狐帝幺女白浅再次将擎苍封印，因此被封法力、记忆和容貌，落入凡尘与夜华相识、相恋，后被带入天宫。天宫中，爱慕夜华的素锦屡次陷害白浅，并让白浅误会夜华冷酷无情，继而又害白浅被挖双眼。白浅伤心欲绝，产子后，纵身跃下诛仙台。因诛仙台戾气破解封印，她恢复记忆，为忘记夜华，饮下忘情药。百年后二人在东海重逢，夜华认出白浅，相随相伴，再续前缘，更唤醒白浅记忆。面对往日仇怨，白浅问素锦讨回双眼，怎料又中了素锦的计，再不肯原谅夜华。此时擎苍再次醒转，夜华来不及解释，亲自斩杀擎苍，付出生命封了东皇钟，面对魂飞魄散的夜华，白浅悔恨自责。幸而三年后，夜华苏醒，二人再续前缘。',7,current_timestamp,4);
insert into vue_Images(image_name,image_path,image_title,image_content,image_category_id,image_create_time,image_view_time) values('keji.jpg','http://192.168.1.3:3000/images/keji.jpg','星际穿越','在不远的未来，随着地球自然环境的恶化，人类面临着无法生存的威胁。这时科学家们在太阳系中的土星附近发现了一 个虫洞，通过它可以打破人类的能力限制，到更遥远外太空寻找延续生命希望的机会。一个探险小组通过这个虫洞穿越到太阳系之外，他们的目标是找到一颗适合人类移民的星球。在这艘名叫做“Endurance”的飞船上，探险队员着面临着前所未有，人类思想前所未及的巨大挑战。然而，通过虫洞后，他们发现飞船上在星球上的一个小时相当于地球上的七年时间，即使探险小组的任务能够完成，他们的救赎对于对地球上仍然活着的人来说已经是太晚。飞行员库珀必须在与自己的儿女重逢以及拯救人类的未来之间做出抉择',8,current_timestamp,3);
--vue-cms前端项目对应的新闻资讯表
--news_title：新闻标题
--news_content：新闻内容
